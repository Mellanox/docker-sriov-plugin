...
RUN go get github.com/Sirupsen/logrus github.com/codegangsta/cli github.com/docker/go-plugins-helpers/network github.com/docker/libnetwork/options github.com/docker/libnetwork/netlabel
